...
const Chat = (props) => {
  ...
  const fetchRooms = async () => {
    ...
    try {
      if (
        props.user.business.category==="1"
      ) {
        res = await axios.get(
          `https://e-taqreeb-api.herokuapp.com/lawn/chatRooms`,
          config
        );
      } else {
        res = await axios.get(`https://e-taqreeb-api.herokuapp.com/photographer/chatRooms`, config);
      }
      if (res.data) {
                    ...
                    <div className="chat-search pt-3 pl-3">
                      <div className="d-flex align-items-center">
                        <div className="chat-profile mr-3">
                          <img
                            src={
                              props.business && props.business.logo
                                ? props.business.logo
                                : anonymosAvatar
                            }
                            alt="chat-user"
                        ...
                        <div className="chat-caption">
                          <h5 className="mb-0">
                            {props.business && props.business.company
