...
import {approveLawn, rejectLawn} from '../../../../actions/admin'
const LawnApprovalForm = ({selectedLawn, approveLawn, rejectLawn}) => {
  ...
  console.log('fetched lawn in approval form:',selectedLawn)
  if(selectedLawn!=null){
  const { address, businessEmail, city, company, description, owner, ownerCnic, phone} = selectedLawn;
  return (
    <div>
              ...
              <div className="iq-card-body">
                ...
                <div className="iq-card-body">
                  <form onSubmit={(e) => onSubmitHandler(e)}>
                    ...
                    <div className="btn btn-primary btn-lg mr-2" onClick={()=>{approveClicked(selectedLawn._id)}}>
                      Approve
                    </div>
                    <div className="btn iq-bg-danger btn-lg" onClick={()=>{rejectLawn(selectedLawn._id)}}>
                      Reject
                    </div>
                  </form>
                </div>
...
export default connect(mapStateToProps, {approveLawn, rejectLawn})(LawnApprovalForm)